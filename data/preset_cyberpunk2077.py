"""
WARFRAME-RELIC UI 字符串 — Cyberpunk 2077 风格（霓虹暗夜）
赛博朋克 2077 主题配色配套文案，沉浸式夜之城黑客体验。
"""
...
STRINGS = {
    ...
    # ── 窗口标题 ──
    "window_title": {
        "management_panel": "WARFRAME-RELIC · 夜之城神经端口（Netrunner 控制台）",
    },

    # ── 主标题 ──
    "title": {
        "management_panel": "WARFRAME-RELIC · 夜之城神经端口",
    },

    # ── 按钮文字 ──
    "button": {
        "exit": "断开连接 · 退出赛博空间",
        "reset_state": "⟳ 系统重置 · 清除全部缓存",
        "reload_hotkeys": "⭮ 重新绑定热键矩阵",
        "fetch_github": "从荒坂子网拉取最新数据 (GitHub)",
        "browse_file": "选择本地数据芯片...",
        "update_db": "写入数据库",
        "update_tutorial": "操作手册",
        "open_data_dir": "打开数据缓存目录",
        "update_from_local": "从本地芯片导入",
        "update_from_network": "从子网拉取更新",
        "toggle_detail_expand": "展开详情",
        "toggle_detail_collapse": "折叠详情",
        "save_hotkeys": "固化热键映射",
        "reset_default": "恢复出厂热键",
        "custom_theme": "⬡ 视觉皮层定制（赛博义体配色）",
        "bilibili_home": "Bilibili 信号节点 →",
        "github_repo": "GitHub 数据堡垒 →",
        "close_log_panel": "关闭日志监视器",
        "search_clear": "清空",
        "apply_preset": "应用预设方案",
        "save_theme": "保存配色方案",
        "refresh_preview": "刷新预览",
        "mode_check_status": "⊞ 遗物出入库状态扫描",
        "mode_query_parts": "◎ 遗物内含物解析",
        "mode_query_price": "⟐ 夜之城市场价格查询",
        "mode_translate": "⬢ 神经翻译（英文→中文）",
        "upload_bg": "上传背景图",
        "clear_bg": "清除背景图",
        "fetch_prices": "同步 warframe.market 黑市行情",
    ...
    # ── 分组标题 ──
    "group": {
        "recovery": "⎅ 系统紧急恢复（异常状态重置）",
        "data_overview": "数据总览",
        "db_center": "数据库管理中心",
        "translation_db": "神经翻译数据库（中英文映射）",
        "items_i18n": "全物品多语言索引库",
        "wm_prices": "⟐ warframe.market 黑市行情",
        "hotkey_settings": "热键矩阵配置",
        "feature_toggles": "⬢ 功能模块开关",
        "theme": "视觉皮层定制",
        "lang_preset": "语言风格 · 文案预设",
        "about_author": "关于 Netrunner",
    },
    ...
    "stat_label": {
        ...
        "items_weapon": "武器分类统计",
        "price_total": "已定价物品数",
        "price_has_sell": "有效卖价条目",
        "price_has_weighted": "检测到压价行为",
    },
    "stat_fmt": {
        "count_items": "{count} 个",
    ...
    "hint": {
        "recovery": "触发系统紧急恢复将执行完整重置序列：\n"
                    ...
                    "当热键失效、界面卡死或识别异常时，请立即执行此操作。",
        "bottom_tip": "提示: 按 Ctrl+Shift+G 打开控制台 | Ctrl+G 框选截图",
        "data_source_relic": "原始数据源: 来自 WFCD 项目的 all.json + i18n.json\n本地数据库: 从原始数据源派生的 SQLite 数据库文件\n点击「从子网拉取」自动下载并清洗，或手动选择本地芯片后写入",
        "data_source_trans": "数据来源: WFCD warframe-items 项目（All.json + i18n.json 双文件关联）",
        ...
        "items_search_placeholder": "输入英文或中文关键词检索物品（单击结果复制英文名）",
        "items_search_default": "输入英文或中文关键词开始检索...",
        "items_query_title": "物品名称检索（中英文双向）",
        "items_search_error": '<span style="color:#ff4444;">检索异常，请检查数据库完整性</span>',
        "items_no_translation": "(暂无中文名)",
        "about_author": "Netrunner: NeonXi (B站信号节点: MichaelJackso2)",
        "version": "WARFRAME-RELIC · 夜之城神经端口 v2.0",
    },
    ...
    "search": {
        ...
        "copied": "已复制到剪贴板: {name}",
        "mode_en2cn": "英文→中文 | 找到 {total} 个（精确:{exact} 前缀:{prefix} 模糊:{contain}）",
        "mode_cn2en": "中文→英文 | 找到 {total} 个（精确:{exact} 前缀:{prefix} 模糊:{contain}）",
    ...
    "hotkey": {
        "not_empty": "不能为空",
        "format_error": "格式不正确",
        "format_error_title": "热键格式错误",
        "format_error_msg": "请修正红色提示的热键设置。\n\n正确格式示例: ctrl+g / alt+shift+f / ctrl+shift+g",
        "save_success": "保存成功",
        "save_success_msg": "热键已保存，即时生效！",
        "save_failed": "保存失败",
        "save_failed_msg": "无法写入配置文件，请检查磁盘空间和权限。",
        "reset_confirm_title": "确认恢复默认热键",
        "reset_confirm_msg": "确定要恢复默认热键吗？\n\n框选截图: {select}\n全屏截图: {fullscreen}\n控制台: {panel}",
        "reset_done_title": "已恢复",
        "reset_done_msg": "热键已恢复为默认值。",
        "label_select": "框选截图",
    ...
    # ── 退出 ──
    "exit": {
        "confirm_title": "确认断开连接",
        "confirm_msg": "确定要退出 WARFRAME-RELIC，断开与赛博空间的连接吗？\n\n退出后所有截图和识别功能将停止工作。",
    },
    ...
    # ── 覆盖层 / Overlay ──
    "overlay": {
        "mode_selected": "▸ 已选择功能模块: {mode}",
        "relics_found": "扫描到 {count} 个遗物实体 — 请选择后续操作：",
        ...
        "query_summary": "遗物内含物解析: {total}个 | 匹配成功 {matched}个",
        "query_summary_fmt": "遗物内含物解析: {total}个 | 匹配成功 {matched}个 | 未匹配: {unmatched}",
        ...
        "price_query_summary": "黑市行情查询: {total}个 | 有价格数据 {with_price}个",
    ...
    # ── 日志消息 ──
    "log_msg": {
        "startup": "WARFRAME-RELIC 夜之城神经端口已上线",
        "startup_select": "{hk:<16}→ 框选截图模式（松手自动触发识别）",
        "startup_fullscreen": "{hk:<16}→ 全屏截图模式（跳过框选，直接全屏识别）",
        "startup_panel": "{hk:<16}→ 打开 Netrunner 控制台",
        "startup_query_price": "{hk:<16}→ 黑市行情查询（自动4等分截图+识别+标注）",
        "startup_right_click": "右键          → 取消框选 / 清除标注 / 关闭功能选择",
        "startup_mode_hint": "截图后将弹出功能模块选择（可在控制台中开关）：",
        "startup_mode_check": "  [出入库查询]     — 标注遗物名称（绿=出库 红=入库）",
        "startup_mode_query": "  [内含物解析]     — 匹配遗物对应的 Prime 部件",
        "startup_mode_price": "  [黑市行情查询]   — 识别物品并查询 warframe.market 价格",
        "startup_mode_translate": "  [神经翻译]       — 识别英文文本并翻译为中文",
        "startup_db_info": "[WFInfo 数据库] 共 {total} 个遗物 | 出库 {available} | 入库 {vaulted}",
        "reset_done": "系统紧急重置完成 — 识别已终止 | 缓存已清除 | 引擎已重初始化 | 热键已重注册 | 配置已重置 | 面板已同步",
        "reset_start": "正在执行系统紧急恢复流程...",
        "hotkeys_reloaded": "热键矩阵已重新注册",
    },

    # ── 数据更新 ──
    "update": {
        "confirm_update_title": "确认写入数据库",
        "confirm_update_msg": "将从以下数据芯片写入数据库:\n{source}\n\n目标数据库: {target}\n\n此操作将覆盖现有数据。确认继续？",
        "file_not_found_title": "芯片未找到",
        "file_not_found_msg": "找不到数据芯片:\n{path}",
        "fetch_confirm_title": "从荒坂子网拉取数据",
        "fetch_confirm_msg": "将通过子网从 GitHub 下载最新数据:\n\n  all.json (掉落数据)\n  i18n.json (多语言翻译，自动清洗)\n\n保存到: {save_path}\n下载完成后将自动更新数据库。\n\n确认开始下载？",
        "browse_dialog_title": "选择 WFInfo 数据芯片",
        "browse_filter": "JSON 文件 (*.json);;所有文件 (*.*)",
        "source_current": "当前数据芯片: {path}",
        "source_not_found": "all.json 未找到: {path}",
        "updating_db": "正在写入数据库...",
        "update_complete": "数据库写入完成！",
        "update_success": "数据库写入成功！\n  遗物: {relics} | 部件: {parts} | 别名: {aliases}\n  出库: {dropping} | 入库: {vaulted}",
        "update_failed": "数据库写入失败",
        "update_error": "数据库写入异常: {msg}",
        "download_success": "下载成功！",
        "download_failed": "下载失败（子网连接中断）",
        "download_complete": "下载完成，正在自动写入数据库...",
        "download_starting": "正在建立子网连接（GitHub）...",
        "trans_confirm_title": "更新翻译数据库",
        "trans_confirm_msg": "将重建神经翻译数据库。\n\n数据源: {source}\n用途: 遗物部件名英→中翻译\n注: 主源失败将自动切换到备用源。\n\n确认继续？",
        ...
        "log_manual_step3": "  ③ 点击「选择本地数据芯片」选中该文件，再点「写入数据库」",
        "downloading_pct": "下载中... 已完成 {pct}%",
        "downloading_pct_wait": "下载中... 已完成 {pct}%，请耐心等待",
        "updating_db_detail": "数据库写入: {msg}",
        "fetch_step_1": "正在解析目标节点，检测子网连通性...",
        "fetch_step_2": "正在解析 DNS，定位 raw.githubusercontent.com...",
        "fetch_step_3": "正在建立 HTTPS 加密隧道（TCP + TLS 握手）...",
        "fetch_step_4": "正在获取文件元信息（大小、类型）...",
        "fetch_step_5": "正在下载 all.json 数据文件...",
        "fetch_step_6": "正在校验 JSON 数据完整性...",
    ...
    "tutorial": {
        ...
        "trans_content": (
            ...
            "方法一：自动下载（推荐）\n"
            "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n"
            "在「数据库管理中心」点击「从子网拉取」按钮，\n"
            "程序将自动下载 all.json 和 i18n.json，\n"
        ...
        "relic_content": (
            ...
            "点击「从子网拉取」会同时下载并处理这两个芯片，\n"
            "其中 i18n.json 会自动清洗（仅保留中英文），\n"
            "然后自动更新遗物数据库和全物品翻译数据库。\n\n"
            "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
            "方法一：自动拉取（推荐）\n"
            "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n"
            "点击「从子网拉取」按钮，程序将自动完成：\n"
            "  ① 下载 all.json（掉落数据）\n"
            "  ② 下载 i18n.json（翻译数据）\n"
            "  ③ 清洗 i18n.json（仅保留 zh/en 语言）\n"
            "  ④ 格式化保存两个芯片\n"
            "  ⑤ 自动更新数据库\n\n"
            "如果 GitHub 子网访问较慢，建议先使用 Watt Toolkit\n"
            "(https://steampp.net/) 加速网络后再操作。\n\n\n"
            "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
            "方法二：手动获取芯片\n"
            "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n"
            ...
            "③ 将获取到的芯片放入以下目录：\n"
            "   {data_dir}\n\n"
            "④ 回到本程序，点击「选择本地数据芯片」选中 all.json，\n"
            "   再点击「写入数据库」即可。\n\n"
            "   i18n.json 放入后会自动被翻译库构建流程识别。\n\n\n"
            "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
            "提示\n"
            "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n"
            "• 使用「从子网拉取」最方便，一键完成所有操作。\n\n"
            "• 仅在自动拉取失败或网络不畅时，才需要手动获取。\n\n"
            "• 如果浏览器无法打开 GitHub 链接，建议先安装\n"
            "  Watt Toolkit 加速网络后再试。\n"
            "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
        ),
    ...
    "price": {
        ...
        "fetch_confirm_title": "确认同步黑市行情",
        "fetch_confirm_msg": "将从 warframe.market API 拉取最新卖价数据。\n\n仅拉取卖价，含反压价权重机制\n偏离中位数 >30% 的低价权重降为 0.1\n\n速率限制: 每秒 3 个请求\n预计耗时: 约 10-15 分钟\n\n确认开始同步？",
        "fetch_done": "黑市行情同步完成！",
        "fetch_done_title": "同步完成",
        "fetch_done_msg": "黑市行情同步完成！\n\n总计: {total} 个物品\n有加权卖价: {with_sell}\n检测到异常低价: {with_weighted}\n异常低价次数: {total_abnormal}\n耗时: {elapsed:.0f}s",
        "fetch_failed_title": "同步失败",
        "fetch_failed_msg": "黑市行情同步失败:\n{error}\n\n请检查网络连接后重试。",
    },
