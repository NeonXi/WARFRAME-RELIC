...
STRINGS = {
    ...
    "stat_label": {
        "relics_total": "遗物实体数",
        "parts_total": "Prime 部件数",
        "aliases_total": "别名映射条目",
        "vaulted": "已入库（绝版）",
        "available": "可获取（出库）",
        "voidtrader": "虚空商人可交易",
        "db_size": "数据库占用",
    ...
    "overlay": {
        ...
        "price_query_scanning": "⚡ 正在扫描物品区域并查询黑市行情...",
    ...
    "update": {
        ...
        "fetch_confirm_msg": "将通过子网从 GitHub 下载最新 all.json:\n\n{url}\n\n保存到: {save_path}\n下载完成后将自动更新数据库。\n\n确认开始下载？",
