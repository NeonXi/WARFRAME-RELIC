...
STRINGS = {
    ...
    # ── 提示文字 ──
        ...
        "items_search_placeholder": "地球语种→三体语种符号映射 · 拼音映射（单击结果条目复制英文标识符）",
        "items_search_default": "输入英文标识符、中文语义标签或拼音启动智子检索...",
        "items_query_title": "物品标识符查询（智子双语+拼音语义索引）",
    ...
    "search": {
        ...
        "mode_result": "检索到 {total} 个候选实体（精确:{exact} 前缀:{prefix} 模糊:{contain}）",
    },
    ...
    "theme_field": {
        ...
        "cyber_blue": "辅助蓝色（四维空间碎片辉光）",
        "dark_bg": "窗口背景（宇宙微波背景辐射）",
        ...
        "color_vaulted": "遗物出库标注（威慑纪元·安全）",
        "color_available": "遗物入库标注（光墓·封存）",
        "color_unknown": "遗物未知标注（未探索文明维度）",
        "color_gold": "金部件·稀有（恒星级品质）",
        "color_silver": "银部件·罕见（行星级品质）",
        "color_copper": "铜部件·常见（卫星级品质）",
        "log_ok": "日志 [成功]（智子自检通过）",
        "log_warn": "日志 [警告]（黑暗森林预警）",
        "log_error": "日志 [错误]（智子异常展开）",
        "log_info": "日志 [信息]（引力波广播记录）",
        "log_debug": "日志 [调试]（智子诊断模式）",
        "log_timestamp": "日志 时间戳（威慑纪元时间）",
        ...
        "primary_disabled_bg": "蓝色主按钮 禁用背景（水滴待命）",
