...
# primary disabled 合并到 btn_disabled
PRIMARY_DISABLED_BG = _proxy('btn_disabled_bg')
PRIMARY_DISABLED_TEXT = _proxy('btn_disabled_text')
PRIMARY_DISABLED_BORDER = _proxy('btn_disabled_border')
